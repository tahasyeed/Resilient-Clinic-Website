...
import { Wrench, Construction } from "lucide-react"; // using lucide-react icons
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-white px-4">
      ...
      <motion.div
        ...
        className="flex items-center justify-center bg-blue-100 p-6 rounded-full shadow-lg"
      >
      ...
      <motion.h1
        ...
        className="mt-6 text-3xl sm:text-4xl font-bold text-gray-900 text-center"
      >
      ...
      <motion.p
        ...
        className="mt-4 text-gray-600 text-center max-w-xl text-lg"
      >
        🚧 We’re working hard to bring you this section soon.  
        Please check back later for updates on our world-class services.
      </motion.p>

      {/* Extra construction icon */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ...
        className="mt-8"
      >
        <Construction className="w-12 h-12 text-gray-400 animate-bounce" />
      </motion.div>
    </div>
  );
};
